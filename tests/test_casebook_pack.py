"""Regression checks for the solidity-amm casebook."""
...
from casebook.harness import assert_expected, solidity_amm_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(solidity_amm_summary(), assert_expected())
