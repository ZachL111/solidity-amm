...
`solidity-amm` is centered on blockchain tooling work in Solidity. The technical target is: Model constant-product AMM swaps and invariant fixtures.
...
The score is deterministic. The current threshold is 153. Risk has a penalty of 6, latency has a penalty of 2, and weight contributes a bonus of 4.
